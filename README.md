...
This repository contains an Excel dataset and a machine learning based on KAIST opensource technology arXiv paper [EMIT Mechanical Intelligence (Prof. IL-Kwon Oh)](https://arxiv.org/abs/1506.02640).
## Open Source Scope
